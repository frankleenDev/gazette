            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{ route('update_forms') }}">Basic Form</a></li>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Breaking News</strong> Elements
                            </div>
                            <div class="card-body card-block">
                                <form action="{{ route('news_upate') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        <!--<div class="col col-md-3"><label for="text-input" class=" form-control-label">News Headline</label>
                                        </div>-->
                                        <div class="col-12 col-md-12"><input style="border-color: transparent;" type="text" id="text-input" name="headline" placeholder="headline..." class="form-control"></div>
                                    </div>
                                    <!--
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">2<sup>nd</sup> Headline</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="headline..." class="form-control"><small class="help-block form-text">Please enter your email</small></div>
                                    </div>
                                    <div class="row form-group">
                                ...
                                -->
                                    <div class="row form-group">
                                        <div class="col-12 col-md-12"><textarea style="border-color: transparent;" name="content" id="textarea-input" rows="21" placeholder="Content..." class="form-control"></textarea></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-12 col-md-12">
                                            <select style="border-color: transparent;" name="category" id="selectSm" class="form-control-sm form-control">
                                    ...
                                    -->
                                    <div style="margin-top: 7%" class="row form-group">
                                        <div class="col col-md-1"></div>
                                        <div class="col col-md-11">
                                            <div class="form-check">
                                                <div class="checkbox">
                                                    <label for="checkbox1" class="form-check-label ">
                                                        <input type="checkbox" id="checkbox1" name="breakingnews" value="1" class="form-check-input"><small>Breaking News</small>
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                    ...
                                    <div style="margin-top: 8%" class="row form-group">
                                        <div class="col col-md-3"><label for="file-multiple-input" class=" form-control-label">Images</label></div>
                                        <div class="col-12 col-md-9"><input type="file" id="file-multiple-input" name="multiple_inputs[]" multiple="" class="form-control-file btn"></div>
                                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <h5><strong>Heading:</strong> {{ $data->headline }}</h5>
                                <br>
                                <div class="row col-md-12">
                                <h6><strong>Article:</strong></h6>
                                    <p>{{ str_limit($data->content, $limit = 550, $end = '...') }}</p>
                                </div>
                                <br>
                                <h5><strong>Images:</strong></h5>
                                <br>
                                <?php 
                                    $image_array=explode(" ", $data->image_urls); 
                                ?> 

                                @foreach( $image_array as $image )

                                    <img class="col-md-3" src="{{ asset($image) }}">
